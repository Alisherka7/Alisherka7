...
*I build cloud systems that control real things: robot fleets, smart farm system, and AI agent powered services.*
...
**R&D Software Engineer @ FutureConnect** — leading the development of a **cloud robot fleet
management system** for smart farms: architecture design for robot–cloud–device integrated
control, IoT device & firmware integration, and cloud-based remote control of industrial PLCs.

```text
Robots / IoT Devices  ⇄  AWS IoT Core  ⇄  EKS (Django · Celery)  ⇄  CloudFront  ⇄  B2B / B2C Apps
```
